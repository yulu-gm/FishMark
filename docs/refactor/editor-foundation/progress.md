...
| --- | --- | --- | --- | --- | --- | --- | --- |
| RF-001 | Editing behavior baseline | — | `DEV_DONE` | Hardened canonical/formal ports, runner/observer/protocol/launcher: 16 focused files / 115 tests; harness + driver: 27 files / 161 tests; Typora validation 14/14; 121-step listener baseline restored; bounded launcher/adapter/public-CLI timeout/abort/nonzero/root-exited/hung-terminator cleanup passed; public scenario passed 121/121 steps in one batch. | Formal Electron gate: 121/121 cases, 2,541 targets, 79 existing + 1,928 runner matches, 534 exact known defects, 0 unexpected, 0 not-run, 25.916s. Deterministically hashed explicit sets cover 2,541/2,541 with 0 gaps. Editing experience: 79/79 passed. lint 0 errors (8 pre-existing warnings); typecheck, 135-file/1,483-test suite, and build passed. | Architecture/task acceptance pending | `codex/editor-foundation-refactor` |
