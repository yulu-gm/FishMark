...
Renderer-owned export orchestration remains responsible for theme/style collection and the outer HTML document shell. Presentation owns the pure Markdown-content HTML, including tables, inline previews, math fallback, Mermaid source fallback, reference media, and footnotes.
